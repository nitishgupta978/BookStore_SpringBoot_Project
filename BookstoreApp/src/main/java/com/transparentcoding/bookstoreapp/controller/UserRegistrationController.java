...
public class UserRegistrationController {
    ...
    //    create for userLoginDto
    @PostMapping("/login")
    public ResponseEntity<ResponseDto> loginUser(@RequestBody UserLoginDto userLoginDto) {

        Optional<UserRegistration> userLogin = userRegistrationService.loginUser(userLoginDto);
        if (userLogin.isPresent()) {
            ResponseDto responseDto = new ResponseDto("User Login Successful", userLogin);
            return new ResponseEntity<ResponseDto>(responseDto, HttpStatus.OK);
        } else {
            ResponseDto responseDto = new ResponseDto("User not Login Successful", userLogin);
            return new ResponseEntity<ResponseDto>(responseDto, HttpStatus.OK);
        }
